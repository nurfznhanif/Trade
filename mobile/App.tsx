...
const styles = StyleSheet.create({
  ...
  sliceRow: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12, borderTopWidth: 1, borderTopColor: "#1e2731" },
  sliceSwatch: { width: 4, alignSelf: "stretch", borderRadius: 2 },
  ...
  sliceStats: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", rowGap: 8, marginTop: 12, marginBottom: 12 },
  ...
  sliceCallout: { flexDirection: "row", alignItems: "flex-start", gap: 8, marginBottom: 12, padding: 10, borderRadius: 10, backgroundColor: "rgba(245,158,11,0.08)", borderWidth: 1, borderColor: "rgba(245,158,11,0.30)" },
  ...
  slicePills: { alignItems: "flex-start", gap: 6, marginTop: 8 },
